...
echo "<a href='../AppAtendimentoFisioterapia/php/autenticacao/sair.php'>Sair</a>";
...
<head>
    ...
    <body>
        ...
        <section>  
             <div class="btnReg">                        
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#novoRegistro">Adicionar atendimento</button>
            </div>                       
        </section> 
                            ...
                            <?php
                                while($registro = $con ->fetch_array()){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img class="icon" src="../img/pencil.svg" alt="">
                                            <img class="icon" src="../img/trash.svg" alt="">
                                        </td>
                                    </tr>
                            <?php } ?>
                ...
                <div class="modal-dialog">
                    ...
                    <form>
                        ...
                        <select class="form-select mb-3" aria-label="Default select example">
                            <option selected>Selecine o fisioterapeuta</option>
                            <option value="1">Rodrigo S. Cardozo</option>
                            <option value="2">Diego Cruz</option>
                            </select>            
                        ...
                        <div class="col-sm mb-3">
                            ...
                            <input type="date" class="form-control" placeholder="Date" aria-label="State">
                        </div>

                        <div class="col-sm mb-3">
                            <label for="exampleInputPassword1" class="form-label">Duração da sessão</label>
                            <input type="time" class="form-control" placeholder="time" aria-label="time">
                        </div>
                        <div class="col-sm mb-3">           
